...
class MilvusVectorDatabase:
    def __init__(self,db_path="./milvus_data",collection_name:str="fusionai_collection",embedding_dim:int=384):
...
if __name__ == "__main__":
    ...
    try:
        chunks = doc_processor.process_document("Data_Structures.pdf")
